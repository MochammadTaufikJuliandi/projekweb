<div class="container-fluid">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" rolee="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </button>
        <a class="carousel-control-next" href="#carouselExampleIndicators" rolee="button" data-slide="next">
    ...
    <?php foreach ($barang as $brg) : ?>
            ...
            <div class="card ml-3 mb-3" style="width: 16rem;">
                ...
                <div class="card-body">
                    ...
                    <span class="badge badge-pill badge-danger mb-3">Rp. <?php echo $brg->harga ?></span>
